...
public class NotSimpleTest {
    ...
    @Title("newLibTransfer")
    @Description("ReallyNewDesc")
    ...
    @Labels({"badabummmmm", "badabummmmm"})
    ...
    public void secondTest() {
        TestITClient.addLink(new LinkItem("test-addLinkNewNewNew", "www.test.com", "testDesc", LinkType.RELATED));
        doSecond();
        doSomething();
    ...
    private void doSecond() {
        TestITClient.addLink(new LinkItem("doSecondDescNewNewNew", "www.drive.google.com", "testDesc", LinkType.RELATED));
        doThird();
    }
